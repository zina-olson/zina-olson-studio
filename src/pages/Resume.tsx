    ...
    return (
      <div>
        <header className="text-center">
          <p className="text-2xl font-mono font-bold pb-12">
            Software QA Automation Engineer
          </p>
        </header>
        <p className="text-lg font-bold pb-4">Professional Summary</p>
        <p className="text-md">
          ...
          <p className="pb-6"></p>
          <p className="text-lg font-bold pb-4">Experience </p>
          <p className="text-md font-semibold">
            Implementation Engineer at Iodine Software, Austin, TX May 2021 -
            May 2022
            <p className="pb-4"></p>
            <p className="font-normal">
              - Functional and non-functional testing, bug reporting through
              Jira.
              <p className="">
                - Deployed a newly integrated solution as part of the beta
                testing team.
              </p>
              <p className="">
                ...
                improvement.
                <p className="">
                  - Project Management responsibilities: data availability
                  discoveries, analyzing and proposing project scope and
                  timeline; presenting the proposed deliverables to the
                  stakeholders.
                </p>
              </p>
              <p className="">
                - Troubleshooting support for client success and support teams.
              </p>
              <p className="">
              ...
              <p className="">
                - Completed three projects starting at $1.3M each. Led 7 smaller
                scale ad-hoc projects.
              </p>
            </p>
          </p>
          <p className="pb-4"></p>
          <p className="text-md font-semibold">
            Technical Account Manager at Yardi Systems, Austin, TX Aug 2017 -
            May 2021
            <p className="pb-4"></p>
            <p className="font-normal">
              <p className="">
                - Evaluated client reports and drove communication with
                Development teams to confirm bug fixes and potential functional
                enhancements in upcoming releases.
              </p>
              <p className="">
                - Wrote SQL scripts, product customizations, modified reports,
          ...
          <p className="pb-6"></p>
          <p className="text-lg font-bold pb-4">Skills and Interests</p>
          Selenium WebDriver, Postman API, Swagger, Lighthouse, GT Metrix,
          ...
          <p className="pb-6"></p>
          <p className="text-lg font-bold pb-4">Education</p>
